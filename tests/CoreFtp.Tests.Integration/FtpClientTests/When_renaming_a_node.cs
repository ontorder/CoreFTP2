...
public class When_renaming_a_node : TestBase
{
    ...
    public async Task Should_rename_directory(FtpEncryption encryption)
    {
        ...
        await sut.CreateDirectoryAsync(oldRandomDirectoryName, default);
        ...
        await sut.DeleteDirectoryAsync(newRandomDirectoryName, default);
    ...
    public async Task Should_rename_file(FtpEncryption encryption)
    {
        ...
        await sut.DeleteFileAsync(subsequentlyRenamedRandomFileName, default);
    }
}
